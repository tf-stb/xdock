...
let a4 = `
    <div id="a4">
       <div class="all_portes">
        <div class="row1 ">
         <a  href="" target="_blank"><div id="T1" class="col porte"><span class="porte_num">T1</span> <span class="window"></span></div></a>
        ...
        <a href="" target="_blank"><div id="T28" class="col porte" ><span class="porte_num">T28</span> <span class="window"></span></div></a>
         <a href="" target="_blank"><div id="T29" class="col porte" ><span class="porte_num">T29</span> <span class="window"></span></div></a>
          <div href="" target="_blank"><div  class="col porte" ><span class="porte_num"></div>
        </div> 

     
      </div>
      <div class="guide d-flex">
      <div class="gud_item"><div class="color free"></div> <span class="title">Portes libres</span>  <span id="total_free"></span></div>
      <div class="gud_item"><div class="color taken"></div>  <span class="title">Portes occupées</span>  <span id="total_taken"></span></div>
      <div class="gud_item"><div class="color blocked"></div> <span class="title">Protes bloquées</span>  <span id="total_blocked"></span></div>
      <div class="gud_item"><div class="color tow_affectation"></div> <span class="title"> Plusieurs camions</span><span id="total_tow_affectation"></span></div>
